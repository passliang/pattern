...
/**
 * @author leon
 * @date 2021-04-22 17:58:22
 */
public class Test {
	public static void main(String[] args) {
		Blog blog = new Blog("张三");
		Blog one = new Blog("李四");
		Creator creator = new Creator("无痕");
		blog.addObserver(creator);
		one.addObserver(creator);
		blog.publish(new Question("怎么使用呢"));
		one.publish(new Question("有没有联系方式私聊下"));
